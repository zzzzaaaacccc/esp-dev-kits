...
#include "brookesia/system_phone/widgets/navigation_bar.hpp"
...
constexpr NavigationBar::Data STYLESHEET_DEFAULT_DARK_NAVIGATION_BAR_DATA = {
    ...
    .button = {
        ...
        .icon_images = {
            gui::StyleImage::IMAGE_RECOLOR_WHITE(&brookesia_phone_image_large_navigation_bar_back_36_36),
            gui::StyleImage::IMAGE_RECOLOR_WHITE(&brookesia_phone_image_large_navigation_bar_home_36_36),
            gui::StyleImage::IMAGE_RECOLOR_WHITE(&brookesia_phone_image_large_navigation_bar_recents_screen_36_36),
        },
        .navigate_types = {
