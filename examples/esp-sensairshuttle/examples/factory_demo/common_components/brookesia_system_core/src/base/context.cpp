...
#if !ESP_BROOKESIA_BASE_CONTEXT_ENABLE_DEBUG_LOG
#   define UTILS_DISABLE_DEBUG_LOG
#endif
#include "private/utils.hpp"
#include "brookesia/system_core/gui/lvgl/lock.hpp"
#include "brookesia/system_core/gui/squareline/ui_comp.h"
...
bool Context::begin(void)
{
    ...
    ESP_UTILS_LOGI(
        "Library version: %d.%d.%d", BROOKESIA_SYSTEM_CORE_VER_MAJOR, BROOKESIA_SYSTEM_CORE_VER_MINOR,
    ...
    ESP_UTILS_CHECK_FALSE_RETURN(core_utils_check_event_code_valid(data_update_event_code), false,
    ...
    ESP_UTILS_CHECK_FALSE_RETURN(core_utils_check_event_code_valid(navigate_event_code), false,
    ...
    ESP_UTILS_CHECK_FALSE_RETURN(core_utils_check_event_code_valid(app_event_code), false,
