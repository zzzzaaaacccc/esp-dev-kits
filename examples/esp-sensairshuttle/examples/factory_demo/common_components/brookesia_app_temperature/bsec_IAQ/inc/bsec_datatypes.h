...
typedef enum {
     ...
     *
     * Dynamically tracks the power-on stabilization of the gas sensor element: stabilization is ongoing (0) or stabilization
    ...
    *
    * The effect of temperature and humidity on the gas resistance is eliminated to a good extend and it is further linearized
...
typedef enum {
    ...
    BSEC_I_SU_GASESTIMATEPRECEDENCE = 13,                /*!< GAS_ESTIMATE is subscribed and take precedence over other requested outputs */
