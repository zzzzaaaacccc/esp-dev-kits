 ...
 * bsec_do_steps_m() processes multiple instances of BSEC library similar to how bsec_do_steps() handles single instance.
 *
 * @param[in,out]   inst            Reference to the pointer containing the instance
 ...
 *
 * As done with bsec_set_configuration(), the initial configuration of BSEC library instance can be customized
 ...
 * BME sensor which uses the correspodning BSEC library instance. Operation of bsec_sensor_control_m() is similar to bsec_sensor_control()
